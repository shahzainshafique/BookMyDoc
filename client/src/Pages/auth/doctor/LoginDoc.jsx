                  ...
                  <form class="space-y-4 md:space-y-6" action="#">
                      ...
                      <div class="flex items-start">
                          ...
                          <div class="ml-2 text-sm">
                            <label for="terms" class="font-light text-gray-500 light:text-gray-300">Keep me Signed in!</label>
                          </div>
                      </div>
                      ...
                      <p class="text-sm font-light text-gray-500 light:text-gray-400">
                          Don't have an account? <a href="/regdoc" class="font-medium text-primary-600 hover:underline light:text-primary-500">Signup here</a>
                      </p>
                  </form>
              </div>
          </div>
